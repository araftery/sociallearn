...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'profiles_student', 'sex',
                      self.gf('django.db.models.fields.CharField')(default='M', max_length=1),
                      keep_default=False)


        # Changing field 'Student.phone'
        db.alter_column(u'profiles_student', 'phone', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

    def backwards(self, orm):
        # Deleting field 'Student.sex'
        db.delete_column(u'profiles_student', 'sex')


        # Changing field 'Student.phone'
        db.alter_column(u'profiles_student', 'phone', self.gf('django.db.models.fields.CharField')(default='5555555555', max_length=25))
