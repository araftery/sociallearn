...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Week.description'
        db.alter_column(u'courses_week', 'description', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'Week.description'
        db.alter_column(u'courses_week', 'description', self.gf('django.db.models.fields.CharField')(default='description', max_length=500))
