...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.cover_photo'
        db.alter_column(u'courses_course', 'cover_photo', self.gf('django.db.models.fields.URLField')(max_length=2000, null=True))

    def backwards(self, orm):

        # Changing field 'Course.cover_photo'
        db.alter_column(u'courses_course', 'cover_photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
