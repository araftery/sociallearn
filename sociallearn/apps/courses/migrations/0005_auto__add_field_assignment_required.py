...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assignment.required'
        db.add_column(u'courses_assignment', 'required',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assignment.required'
        db.delete_column(u'courses_assignment', 'required')
