...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.cover_photo'
        db.add_column(u'courses_course', 'cover_photo',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Course.cover_photo'
        db.delete_column(u'courses_course', 'cover_photo')
