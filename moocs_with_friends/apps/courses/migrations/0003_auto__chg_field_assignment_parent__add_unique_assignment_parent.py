...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Assignment.parent'
        db.alter_column(u'courses_assignment', 'parent_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['courses.Assignment']))
        # Adding unique constraint on 'Assignment', fields ['parent']
        db.create_unique(u'courses_assignment', ['parent_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Assignment', fields ['parent']
        db.delete_unique(u'courses_assignment', ['parent_id'])


        # Changing field 'Assignment.parent'
        db.alter_column(u'courses_assignment', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Assignment'], null=True))
    ...
    models = {
        ...
        u'courses.assignment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'child'", 'unique': 'True', 'null': 'True', 'to': u"orm['courses.Assignment']"}),
